...
import { addMemberToDaoCall } from "../../utils/evmContractInteraction";
...
export const DAOModal = ({modelId, isOpen, onClose}) => {
  ...
  async function onSubmit() {
    ...
    await addMemberToDaoCall(modelId, priceValue)
  }

  return (
    <Dialog open={!!modelId}  maxWidth="xs" fullWidth>
      <DialogTitle>Add member to Model id: {modelId}</DialogTitle>
